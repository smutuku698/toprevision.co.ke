...
const FILL_ITEMS: { before: string; after: string; answer: string; gloss: string }[] = [
  { before: "Im ", after: " ist es oft heiß und trocken.", answer: "Sommer", gloss: "Im Sommer ist es oft heiß und trocken. — In summer it is often hot and dry." },
  { before: "Im ", after: " wird es kalt, und die Blätter fallen.", answer: "Herbst", gloss: "Im Herbst wird es kalt, und die Blätter fallen. — In autumn it gets cold, and the leaves fall." },
  { before: "Im ", after: " schneit es oft in Deutschland.", answer: "Winter", gloss: "Im Winter schneit es oft in Deutschland. — In winter it often snows in Germany." },
  { before: "Im ", after: " werden die Tage wieder wärmer.", answer: "Frühling", gloss: "Im Frühling werden die Tage wieder wärmer. — In spring the days get warmer again." },
  { before: "Die Sonne ", after: ".", answer: "scheint", gloss: "Die Sonne scheint. — The sun is shining." },
  { before: "Es ", after: " draußen.", answer: "regnet", gloss: "Es regnet draußen. — It is raining outside." },
  { before: "Im Winter trage ich eine ", after: ".", answer: "Mütze", gloss: "Im Winter trage ich eine Mütze. — In winter I wear a cap." },
  { before: "Im Sommer trage ich eine ", after: ".", answer: "Sonnenbrille", gloss: "Im Sommer trage ich eine Sonnenbrille. — In summer I wear sunglasses." },
  { before: "Wenn es regnet, nehme ich einen ", after: " mit.", answer: "Regenschirm", gloss: "Wenn es regnet, nehme ich einen Regenschirm mit. — When it rains, I take an umbrella." },
  { before: "In Kenia gibt es keinen ", after: ".", answer: "Schnee", gloss: "In Kenia gibt es keinen Schnee. — In Kenya there is no snow." },
  { before: "Im Winter trage ich einen warmen ", after: ".", answer: "Pullover", gloss: "Im Winter trage ich einen warmen Pullover. — In winter I wear a warm sweater." },
  { before: "Im Sommer trage ich gern ", after: ".", answer: "Sandalen", gloss: "Im Sommer trage ich gern Sandalen. — In summer I like wearing sandals." },
];

const ORDER_SETS: { chunks: string[]; sentence: string }[] = [
  { chunks: ["Wie ist", "das Wetter", "heute", "?"], sentence: "Wie ist das Wetter heute?" },
  ...
  { chunks: ["Wenn es regnet,", "nehme ich", "einen Regenschirm mit", "."], sentence: "Wenn es regnet, nehme ich einen Regenschirm mit." },
];

const SEASONS: Season[] = ["der Frühling", "der Sommer", "der Herbst", "der Winter"];

function clothingScenario(rng: () => number) {
  ...
  return {
    ...
    prompt: `Es ist ${season} in Deutschland. Was trägt man normalerweise?`,
    choices,
    correctIndex: choices.indexOf(correct),
    layout: "list" as const,
    hint: "Think about which clothing item actually fits that season's typical weather.",
    explanation: `${correct} passt zu ${season}, weil das Wetter in dieser Jahreszeit dazu passt — die anderen Optionen passen besser zu einer anderen Jahreszeit.`,
  };
}
...
export const weatherSpeaking: Skill = {
  ...
  description: "German vocabulary for the four seasons, weather, and season-appropriate clothing, comparing Kenya and Germany.",
  generate(rng) {
    const branch = randChoice(rng, ["match", "categorize", "fill", "order", "clothing"] as const);
    ...
    if (branch === "match") {
      ...
      return {
        kind: "click-match",
        prompt: "Match each German weather or season word to its English meaning.",
        tokens,
        targets,
        correctMap,
    ...
    if (branch === "categorize") {
      ...
      return {
        kind: "categorize",
        prompt: "Sort each word as a Season or a Clothing item.",
    ...
    if (branch === "fill") {
      ...
      return {
        kind: "fill-blank",
        prompt: "Fill in the missing word to complete the German sentence about weather, seasons, or clothing.",
        before: item.before,
        after: item.after,
    ...
    if (branch === "order") {
      ...
      return {
        kind: "ordering",
        prompt: "Arrange the words/phrases to form a correct German sentence about weather or seasons.",
