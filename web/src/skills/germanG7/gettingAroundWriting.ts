...
const FILL_ITEMS: { before: string; after: string; answer: string; gloss: string }[] = [
  { before: "Ich schreibe: Wie komme ich zur ", after: "?", answer: "Schule", gloss: "Wie komme ich zur Schule? — How do I get to the school?" },
  { before: "Ich schreibe: Wo finde ich die ", after: "?", answer: "Bäckerei", gloss: "Wo finde ich die Bäckerei? — Where do I find the bakery?" },
  { before: "In meiner Wegbeschreibung steht: Geh nach ", after: "!", answer: "rechts", gloss: "Geh nach rechts! — Go to the right!" },
  { before: "In meiner Wegbeschreibung steht: Geh nach ", after: "!", answer: "links", gloss: "Geh nach links! — Go to the left!" },
  { before: "In meiner Wegbeschreibung steht: Geh ", after: "!", answer: "geradeaus", gloss: "Geh geradeaus! — Go straight ahead!" },
  { before: "Ich schreibe: Die Apotheke ist ", after: " der Bäckerei.", answer: "neben", gloss: "Die Apotheke ist neben der Bäckerei. — The pharmacy is next to the bakery." },
  { before: "Ich schreibe: Der Park ist ", after: " der Schule.", answer: "gegenüber", gloss: "Der Park ist gegenüber der Schule. — The park is across from the school." },
  { before: "Ich schreibe: Die Bank ist ", after: " der Kirche und dem Krankenhaus.", answer: "zwischen", gloss: "Die Bank ist zwischen der Kirche und dem Krankenhaus. — The bank is between the church and the hospital." },
  { before: "Ich schreibe: Ich gehe zum ", after: ", um einen Brief zu senden.", answer: "Postamt", gloss: "Ich gehe zum Postamt, um einen Brief zu senden. — I go to the post office to send a letter." },
  { before: "Ich schreibe: Die Kinder spielen auf dem ", after: ".", answer: "Spielplatz", gloss: "Die Kinder spielen auf dem Spielplatz. — The children play at the playground." },
  { before: "Ich schreibe: Ich warte am ", after: " auf den Bus.", answer: "Busbahnhof", gloss: "Ich warte am Busbahnhof auf den Bus. — I wait for the bus at the bus station." },
  { before: "Ich schreibe: Wo finde ich die ", after: "? Ich möchte ein Buch ausleihen.", answer: "Bibliothek", gloss: "Wo finde ich die Bibliothek? Ich möchte ein Buch ausleihen. — Where do I find the library? I'd like to borrow a book." },
];
...
function directionsNoteScenario(rng: () => number) {
  ...
  const prompts: Record<string, string> = {
    links: `Du schreibst eine Wegbeschreibung: Du bist bei ${start}. ${destination} ist links von ${start}. Was schreibst du?`,
    rechts: `Du schreibst eine Wegbeschreibung: Du bist bei ${start}. ${destination} ist rechts von ${start}. Was schreibst du?`,
    geradeaus: `Du schreibst eine Wegbeschreibung: Du bist bei ${start}. ${destination} liegt geradeaus von ${start}. Was schreibst du?`,
  };
  ...
  return {
    ...
    hint: "Match the written instruction to where the destination actually is.",
    explanation: `${destination} ist ${direction === "geradeaus" ? "geradeaus" : `nach ${direction}`} von ${start}, also lautet der richtige Satz: "${correct}"`,
  };
}

export const gettingAroundWriting: Skill = {
  id: "g7-de-w-getting-around",
  code: "W.9",
  subjectId: "german",
  strandId: "g7-de-writing",
  grade: 7,
  title: "Getting around: in the neighbourhood",
  description: "Guided writing of simple direction instructions in German using prepositions of location and neighbourhood vocabulary.",
  generate(rng) {
    ...
    if (branch === "match") {
      ...
      return {
        kind: "click-match",
        prompt: "Match each written German neighbourhood place to its English meaning.",
        tokens,
        targets,
        correctMap,
        hint: "These are all places you might write about in a neighbourhood note.",
    ...
    if (branch === "categorize") {
      ...
      return {
        kind: "categorize",
        prompt: "Sort each written word as a Place or a Direction word.",
    ...
    if (branch === "fill") {
      ...
      return {
        kind: "fill-blank",
        prompt: "Fill in the missing word to complete the written German sentence about directions.",
        before: item.before,
        after: item.after,
    ...
    if (branch === "order") {
      ...
      return {
        kind: "ordering",
        prompt: "Arrange the words/phrases to write a correct German sentence about directions.",
    ...
    return directionsNoteScenario(rng);
  },
};
