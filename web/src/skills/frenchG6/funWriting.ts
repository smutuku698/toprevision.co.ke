...
const FILL_ITEMS: { before: string; after: string; answer: string; gloss: string }[] = [
  { before: "Je joue ", after: " football.", answer: "au", gloss: "Je joue au football. — I play football." },
  { before: "Tu joues ", after: " cartes.", answer: "aux", gloss: "Tu joues aux cartes. — You play cards." },
  { before: "Nous jouons ", after: " marelle.", answer: "à la", gloss: "Nous jouons à la marelle. — We play hopscotch." },
  { before: "Il joue ", after: " basketball.", answer: "au", gloss: "Il joue au basketball. — He plays basketball." },
  { before: "Elles jouent ", after: " échecs.", answer: "aux", gloss: "Elles jouent aux échecs. — They (f) play chess." },
  { before: "Je joue ", after: " tennis avec mon ami.", answer: "au", gloss: "Je joue au tennis avec mon ami. — I play tennis with my friend." },
  { before: "Vous jouez ", after: " dames ?", answer: "aux", gloss: "Vous jouez aux dames ? — Do you play draughts?" },
  { before: "Ma sœur joue ", after: " corde à sauter.", answer: "à la", gloss: "Ma sœur joue à la corde à sauter. — My sister plays skipping rope." },
  ...
  { before: "Tu joues ", after: " volleyball ?", answer: "au", gloss: "Tu joues au volleyball ? — Do you play volleyball?" },
...
const NOTE_SCENARIOS: { note: string; correct: string; distractors: string[]; explanation: string }[] = [
  {
    note: "You are writing a short composition about your favorite sport, football.",
    correct: "Je joue au football.",
    distractors: ["Je joue aux football.", "Je joue à football.", "Je joue le football."],
  ...
  {
    note: "You are writing that your friend plays cards after school.",
    correct: "Il joue aux cartes après l'école.",
    distractors: ["Il joue au cartes après l'école.", "Il joue à la cartes après l'école.", "Il joue les cartes après l'école."],
    explanation: "'cartes' is plural, so 'à' + 'les' contracts to 'aux' — 'au' and 'à la' are for singular nouns, so they don't match.",
  },
  {
    note: "You are describing a playground game, hopscotch, that the girls play at break time.",
  ...
  {
    note: "You are writing a caption for a photo of your class playing chess.",
  ...
  {
    note: "You want to write your composition stating that netball is your favorite game.",
  ...
  {
    note: "You are writing about a sports personality you admire and want to say she plays basketball very well.",
  ...
  {
    note: "You are writing that your brother plays draughts with his grandfather every Sunday.",
  ...
  {
    note: "You are writing a short paragraph saying you enjoy playing skipping rope during break.",
  ...
  {
    note: "You are filling in a sports-day form and want to write that you play rugby on Saturdays.",
  ...
  {
    note: "You are writing a class survey answer stating tennis is your favorite sport.",
  ...
  {
    note: "You are writing that your whole class plays volleyball together on Fridays.",
  ...
  {
    note: "You are writing a description of a badminton match you watched, saying the players play badminton very fast.",
...
export const funWriting: Skill = {
  ...
  grade: 6,
  title: "Sports and games preferences",
  description: "Guided writing about sports and games, practicing the 'jouer à/au/aux' structure and stating preferences.",
  generate(rng) {
    ...
    if (branch === "match") {
      ...
      return {
        kind: "click-match",
        prompt: "Match each written French sport or game to its English meaning.",
        tokens,
        targets,
        correctMap,
    ...
    if (branch === "categorize") {
      ...
      return {
        kind: "categorize",
        prompt: "Sort each written word as a Sport or a Game.",
    ...
    if (branch === "fill") {
      ...
      return {
        kind: "fill-blank",
        prompt: "Fill in the missing word ('au', 'aux', or 'à la') to complete the written sentence.",
        before: item.before,
        after: item.after,
    ...
    if (branch === "order") {
      ...
      return {
        kind: "ordering",
        prompt: "Arrange the words/phrases to write a correct French sentence about sports and games.",
