...
const WORDS: { word: string; meaning: string; tag: Tag }[] = [
  ...
  { word: "la danse", meaning: "dance", tag: "activity" },
...
const FILL_ITEMS: { before: string; after: string; answer: string; gloss: string }[] = [
  ...
  { before: "Je regarde le ", after: " pendant les vacances.", answer: "cinéma", gloss: "Je regarde le cinéma pendant les vacances. — I watch movies during the holidays." },
  ...
  { before: "J'aime la ", after: " le week-end.", answer: "danse", gloss: "J'aime la danse le week-end. — I like dance on the weekend." },
...
const SCENARIOS: { situation: (name: string) => string; correct: string; distractors: string[]; explanation: string }[] = [
  {
    situation: (n) => `${n} asks what you like doing during a long school holiday.`,
    correct: "J'aime la lecture pendant les vacances.",
    distractors: ["J'aime la lecture à la récréation.", "Je fais du sport le week-end.", "Je regarde le cinéma après les cours."],
    explanation: "The sentence must use 'les vacances' (the holidays) to match the timeframe asked about — the others name a different time.",
  },
  {
    situation: (n) => `${n} asks what you do during the short break between lessons at school.`,
    correct: "Je joue aux jeux vidéo à la récréation.",
    distractors: ["Je joue aux jeux vidéo le week-end.", "Je fais du sport pendant les vacances.", "J'aime la musique après les cours."],
    explanation: "'À la récréation' means 'at break time' — the others describe a different time period.",
  },
  {
    situation: (n) => `${n} asks what you like doing right after school finishes each day.`,
    correct: "J'aime la danse après les cours.",
    distractors: ["J'aime la danse le week-end.", "Je regarde le cinéma pendant les vacances.", "Je fais du sport à la récréation."],
    explanation: "'Après les cours' means 'after class' — the others name a weekend, holiday, or break-time activity instead.",
  },
  {
    situation: (n) => `${n} asks what you enjoy doing on Saturdays and Sundays.`,
    correct: "J'aime le sport le week-end.",
    distractors: ["J'aime le sport après les cours.", "Je fais de la peinture à la récréation.", "Je lis pendant les vacances."],
    explanation: "'Le week-end' refers to Saturday and Sunday specifically — the others name a different time.",
  },
  {
    situation: (n) => `${n} tells you they enjoy painting, and asks when you paint too.`,
    correct: "Je fais de la peinture pendant les vacances.",
    distractors: ["Je fais de la peinture à la récréation.", "J'aime le sport pendant les vacances.", "Je regarde le cinéma le week-end."],
    explanation: "This response correctly matches the activity (painting) with a specific leisure time — the others change the activity or aren't about painting.",
  },
];
...
export const funSpeaking: Skill = {
  ...
  grade: 7,
  title: "Leisure time",
  description: "Vocabulary for leisure activities and when they happen — after class, at break, on weekends, and during holidays.",
  generate(rng) {
    ...
    if (branch === "match") {
      ...
      return {
        kind: "click-match",
        prompt: "Match each French leisure-time word to its English meaning.",
        tokens,
        targets,
        correctMap,
    ...
    if (branch === "categorize") {
      ...
      return {
        kind: "categorize",
        prompt: "Sort each word as a Time Expression or a Leisure Activity.",
    ...
    if (branch === "fill") {
      ...
      return {
        kind: "fill-blank",
        prompt: "Fill in the missing word to complete the sentence about leisure time.",
        before: item.before,
        after: item.after,
        correctAnswer: item.answer,
        acceptedAnswers: accentAccepted(item.answer),
        inputMode: "text",
        hint: "Think about which activity or time expression fits this sentence.",
    ...
    if (branch === "order") {
      ...
      return {
        kind: "ordering",
        prompt: "Arrange the words/phrases to form a correct French sentence about leisure time.",
