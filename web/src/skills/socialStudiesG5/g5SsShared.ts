...
// Shared helpers for KICD Grade 5 Social Studies skills — Kenyan name/place pools plus reusable
...
const IDENTIFY_FRAMES: ((what: string) => string)[] = [
  ...
  (w) => `Work out which ${w} is being described.`,
];
